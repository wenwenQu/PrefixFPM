...
class GraphState {
  public:
    struct GSDeletedEdge {
      ...
      Mark cyclemark;
      GSDeletedEdge(){};
      GSDeletedEdge(const GSDeletedEdge& obj){
    	  tonode= obj.tonode;
    	  fromnode= obj.fromnode;
    	  edgelabel= obj.edgelabel;
    	  postonode= obj.postonode;
    	  posfromnode= obj.posfromnode;
    	  close= obj.close;
    	  cyclemark= obj.cyclemark;
      }
    };

    /*
    GraphState& operator = (GraphState &obj){
    	if (this == &obj)
    		return *this;
    	deletededges.assign(obj.deletededges.begin(), obj.deletededges.end());
    	treetuples = (obj.treetuples);
    	closetuples = (obj.closetuples);
    	nodesinpreorder.assign(obj.nodesinpreorder.begin(), obj.nodesinpreorder.end());
    	backbonelength = obj.backbonelength;
    	startsecondpath = obj.startsecondpath;
    	nasty = obj.nasty;
    	centerlabel = obj.centerlabel;
    	bicenterlabel = obj.bicenterlabel;
    	closecount = obj.closecount;
    	selfdone= obj.selfdone;
    	nodes.assign(obj.nodes.begin(), obj.nodes.end());
        edgessize = obj.edgessize;
    	return *this;
    }
    */
    ...
    struct GSNode {
      ...
      vector<GSEdge> edges;
      GSNode(){};
      GSNode(const GSNode& obj){
    	  label = obj.label;
    	  maxdegree = obj.maxdegree;
    	  edges.assign(obj.edges.begin(), obj.edges.end());
      }
    };
    ...
    vector<GSNode> nodes; // by wenwen : GS => Graph Start???
    int edgessize;
