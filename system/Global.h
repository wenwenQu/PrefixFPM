...
int tauDB_time = 0.1; // task running time threshold, below which task is inserted into queue directly
bool binary_input = false; // can only be true for Sleuth

int total_item = 0; // total number of item in transaction database, only used in clospan
